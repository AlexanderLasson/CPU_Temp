/**
 * @Author: Alexander Lasson 
 * @Date:   06/12/2022
 *
 * 
 * Description: 
 *      This program reads in a file of CPU core temp and finds the line of best fit
 *      using either least squares and interpolation.
 *      The program then outputs the approximation for a point to a txt file. 
 */
